...
if ($articleId > 0) {
    ...
    // Charger les mots-clés de l'article
    ...
    // Vérifier si l'utilisateur a déjà liké (si connecté)
    $userHasLiked = false;
    ...
    // Charger les COMMENTAIRES (seulement ceux validés et non supprimés)
                            ...
                            <div>
                                ...
                                <span class="text-muted ms-3">
                                    ...
                                    if (!empty($article['dtCreaArt'])) {
                                        echo date('M d, Y', strtotime($article['dtCreaArt']));
                                    } else {
                                        echo date('M d, Y');
                                    }
                                    ?>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
                                <button type="button" 
                                    ...
                                    <i class="<?php echo $userHasLiked ? 'fas' : 'far'; ?> fa-heart me-2"></i>
                    ...
                    <div class="article-comments mt-5">
                            ...
                            <div class="card mb-4" style="border: 2px solid #f8f9fa;">
                                <div class="card-body">
                                    ...
                                    <form id="commentForm">
                                        ...
                                        <button type="submit" class="btn" id="submitCommentBtn" style="background-color: #2F509E; color: white; border: none;">
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">
                                ...
                                <a href="/views/backend/security/login.php" class="alert-link">Connectez-vous</a> 
...
<!-- JavaScript pour LIKES et COMMENTAIRES en AJAX -->
<script>
    ...
    if (commentForm) {
        commentForm.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                submitBtn.innerHTML = '<i class="fas fa-paper-plane me-2"></i>Publier le commentaire';
            })
            .catch(error => {
                console.error('Erreur:', error);
                messagesDiv.innerHTML = `
...
<?php else: ?>
    <div class="container py-5">
        ...
        <a href="/views/frontend/articles.php" class="btn btn-primary" style="background-color: #2F509E; border: none;">
            Retour aux articles
        </a>
    </div>
<?php endif; ?>
